...
export class RegisterComponent {
  ...
  getFieldError(fieldName: string): string {
    ...
    if (field && field.errors && (field.dirty || field.touched)) {
      if (field.errors['required']) {
        return this.translateService.translate('auth.fieldRequired', {
          field: this.getFieldDisplayName(fieldName),
        });
      }
      ...
      if (field.errors['minlength']) {
        ...
        return this.translateService.translate('register.fieldMinLength', {
          field: this.getFieldDisplayName(fieldName),
          min: requiredLength,
        });
      }
  ...
  private getFieldDisplayName(fieldName: string): string {
    const displayNames: { [key: string]: string } = {
      ...
      confirmPassword: this.translateService.translate(
