    ...
    <section class="relative bg-gradient-to-br from-green-600 to-green-800 text-white py-20 px-4 md:px-8 lg:px-32">
      <div class="max-w-6xl mx-auto text-center">
        ...
        <p class="font-['DM_Sans'] text-base md:text-lg max-w-4xl mx-auto opacity-80 leading-relaxed">
          Benvenuto nella sezione dedicata alla nostra azienda. Qui potrai conoscere meglio chi siamo, la nostra storia, i nostri valori e il team che ogni giorno lavora per offrirti i migliori prodotti e servizi nel settore dell'edilizia sostenibile e dell'efficienza energetica.
        </p>
      </div>
    </section>
      ...
      <div class="max-w-6xl mx-auto">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div class="space-y-6">
            ...
            <p class="font-['DM_Sans'] text-base text-gray-600 leading-relaxed">
              La nostra missione è semplice: rendere accessibili a tutti le soluzioni più innovative per l'edilizia sostenibile, accompagnando i nostri clienti dalla progettazione alla realizzazione dei loro sogni abitativi.
            </p>
          </div>
