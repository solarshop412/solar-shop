...
export class CartEffects {
  ...
  addToCart$ = createEffect(() =>
    this.actions$.pipe(
      ...
      tap((action) =>
        console.debug('Cart Effect - addToCart action received:', action),
      ),
    ...
    this.actions$.pipe(
      ...
      switchMap(({ itemId, quantity }) =>
        this.cartService.updateCartItem(itemId, quantity).pipe(
          ...
          catchError((error) =>
            of(CartActions.updateCartItemFailure({ error: error.message })),
          ),
        ),
      ),
    ),
      ...
      switchMap(({ itemId }) =>
        this.store.select(selectCartItems).pipe(
          ...
          switchMap((items) => {
            ...
            if (!item)
              return of(
                CartActions.updateCartItemFailure({ error: 'Item not found' }),
              );
          ...
          switchMap((items) => {
            ...
            if (newQuantity <= 0 || newQuantity < item.minQuantity) {
              ...
              return this.cartService.removeFromCart(itemId).pipe(
                ...
                catchError((error) =>
                  of(
                    CartActions.removeFromCartFailure({ error: error.message }),
                  ),
                ),
              );
            }
    ...
    this.actions$.pipe(
      ...
      switchMap(({ code }) =>
        this.cartService.applyCoupon(code).pipe(
          ...
          catchError((error) =>
            of(CartActions.applyCouponFailure({ error: error.message })),
          ),
        ),
      ),
    ),
    ...
    this.actions$.pipe(
      ...
      switchMap(({ couponId }) =>
        this.cartService.removeCoupon(couponId).pipe(
          ...
          catchError((error) =>
            of(CartActions.removeCouponFailure({ error: error.message })),
          ),
        ),
      ),
    ),
    ...
    this.actions$.pipe(
      ...
      switchMap(() =>
        this.cartService.loadAvailableCoupons().pipe(
          map((coupons) =>
            CartActions.loadAvailableCouponsSuccess({ coupons }),
          ),
          catchError((error) =>
            of(
              CartActions.loadAvailableCouponsFailure({ error: error.message }),
            ),
          ),
        ),
      ),
        ...
        ({
          ...
          this.cartService
            ...
            .pipe(
              ...
              catchError((error) =>
                of(
                  CartActions.addToCartFromOfferFailure({
                    error: error.message,
                  }),
                ),
              ),
      ...
      switchMap(
        ({
          ...
          this.cartService
            ...
            .pipe(
              map(({ cart, addedCount, skippedCount }) =>
                CartActions.addAllToCartFromOfferSuccess({
                  cart,
                  addedCount,
                  skippedCount,
                }),
              ...
              catchError((error) =>
                of(
                  CartActions.addAllToCartFromOfferFailure({
                    error: error.message,
                  }),
                ),
              ),
