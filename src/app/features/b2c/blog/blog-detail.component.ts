  ...
  template: `
    <div class="min-h-screen bg-gray-50">
      ...
      <div *ngIf="error && !loading" class="max-w-2xl mx-auto text-center py-20">
        ...
        <h2 class="text-2xl font-bold text-gray-900">{{ 'blog.articleNotFound' | translate }}</h2>
        <p class="text-gray-600 mt-4 mb-8">{{ error }}</p>
        <button 
      ...
      <div *ngIf="blogPost && !loading">
        ...
        <article class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div class="bg-gray-50 rounded-lg p-6">
            <h3 class="text-lg font-semibold mb-4">{{ 'blog.shareArticle' | translate }}</h3>
        ...
        <section class="bg-white py-16" *ngIf="relatedPosts.length > 0">
          <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 class="text-3xl font-bold text-gray-900 mb-12 text-center">{{ 'blog.relatedArticles' | translate }}</h2>
        ...
        <section class="bg-gradient-to-r from-green-600 to-green-700 py-16">
          <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 class="text-3xl font-bold text-white mb-4">{{ 'blog.stayUpdated' | translate }}</h2>
