  ...
  features: [
    {
      ...
      description:
        'Practical advice to reduce waste and optimize consumption of systems and renewable energy.',
    ...
    },
    {
      ...
      description:
        'Products certified according to the highest environmental standards (LEED, BREEAM, ISO 14001, etc.).',
    ...
    },
    {
      ...
      description:
        'Certified low environmental impact products for eco-friendly construction.',
      icon: '<svg fill="currentColor" viewBox="0 0 24 24"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg>',
