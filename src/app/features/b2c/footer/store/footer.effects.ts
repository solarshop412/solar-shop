  ...
  loadFooterData$ = createEffect(() => {
    return this.actions$.pipe(
              ...
              links: [
                {
                  ...
                  url: '/proizvodi/building-materials',
                },
                {
                  label: 'Electrical Systems',
                  url: '/proizvodi/electrical-systems',
                },
                {
                  label: 'Energy Solutions',
                  url: '/proizvodi/energy-solutions',
                },
                {
                  label: 'Finishes & Coatings',
                  url: '/proizvodi/finishes-coatings',
                },
                {
                  label: 'Tools & Accessories',
                  url: '/proizvodi/tools-accessories',
                },
              ],
            },
            {
      ...
      catchError((error) => {
        ...
        return of(
          FooterActions.loadFooterDataFailure({
