...
export const ProductListActions = createActionGroup({
  ...
  events: {
    ...
    'Load Products From Cache': props<{
      products: Product[];
      currentPage: number;
    }>(),
    ...
    'Toggle Certificate Filter': props<{
      certificate: string;
      checked: boolean;
    }>(),
    'Toggle Manufacturer Filter': props<{
      manufacturer: string;
      checked: boolean;
    }>(),
    ...
    'Load Category Counts Success': props<{
    ...
    'Load Manufacturer Counts Success': props<{
