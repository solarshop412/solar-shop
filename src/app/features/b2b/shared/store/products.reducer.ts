...
export const productsReducer = createReducer(
  ...
  on(
    ProductsActions.updatePaginationInfo,
    (state, { totalItems, totalPages }) => ({
      ...state,
      pagination: {
        ...state.pagination,
        totalItems,
  ...
  on(
    ProductsActions.loadAllManufacturersSuccess,
    (state, { manufacturers }) => ({
      ...state,
  ...
  on(
    ProductsActions.loadCategoryCountsSuccess,
