...
@Component({
  ...
  template: `
    <div class="min-h-screen bg-gray-50">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="bg-white p-6 rounded-lg shadow-md">
                  <div class="w-12 h-12 bg-solar-100 rounded-lg flex items-center justify-center mb-4">
                    <svg class="w-6 h-6 text-solar-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="flex justify-center">
              <div class="relative">
                <div class="w-96 h-96 bg-gradient-to-br from-solar-100 to-solar-200 rounded-full flex items-center justify-center">
                  <svg class="w-32 h-32 text-solar-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div class="bg-white p-6 rounded-lg shadow-md text-center">
              <div class="w-16 h-16 bg-accent-100 rounded-lg flex items-center justify-center mx-auto mb-4">
                <svg class="w-8 h-8 text-solar-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <section class="py-16 lg:py-24 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div class="text-center mb-12">
            ...
            <p class="text-xl text-solar-500 max-w-3xl mx-auto font-['DM_Sans']">
          ...
          <div class="bg-gray-50 rounded-2xl p-8 lg:p-12">
            <div class="text-center mb-8">
              ...
              <p class="text-lg text-solar-500 font-['DM_Sans']">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div class="text-center">
                <div class="w-16 h-16 bg-solar-500 rounded-full flex items-center justify-center mx-auto mb-4">
      ...
      <!-- CTA Section -->
      <section class="py-16 lg:py-24 bg-solar-500">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <a routerLink="/partneri/registracija" 
               class="bg-white text-solar-500 px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors inline-flex items-center justify-center font-['DM_Sans']">
