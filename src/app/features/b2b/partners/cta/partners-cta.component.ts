...
@Component({
  ...
  template: `
    <section class="py-16 bg-orange-600 text-center">
      <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
          <button *ngIf="!isAuthenticated" class="bg-white text-orange-600 px-8 py-4 rounded-lg font-semibold hover:bg-orange-50 transition-all" (click)="navigateToRegister()">
