...
export const loadCompanies = createAction(
  '[Admin Company Pricing] Load Companies',
);
...
export const loadProducts = createAction(
  '[Admin Company Pricing] Load Products',
);
...
export const loadCompanyPricing = createAction(
  '[Admin Company Pricing] Load Company Pricing',
);
...
export const createCompanyPricing = createAction(
  ...
  props<{
    pricing: Omit<CompanyPricing, 'id' | 'created_at' | 'updated_at'>;
  }>(),
);
...
export const clearCompanyPricingState = createAction(
  '[Admin Company Pricing] Clear State',
);
