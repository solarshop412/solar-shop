...
export const companyPricingReducer = createReducer(
  ...
  on(
    CompanyPricingActions.loadCompanyPricingSuccess,
    (state, { companyPricing }) => ({
      ...state,
      companyPricing,
      loading: false,
      error: null,
  ...
  on(
    CompanyPricingActions.createCompanyPricingSuccess,
    (state, { pricing }) => ({
      ...state,
  ...
  on(
    CompanyPricingActions.updateCompanyPricingSuccess,
    (state, { pricing }) => ({
      ...state,
  ...
  // Clear state
  on(
    CompanyPricingActions.clearCompanyPricingState,
    () => initialAdminCompanyPricingState,
  ),
);
