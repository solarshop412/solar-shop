...
export class AdminOrdersPartnersComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    this.title.setTitle(
      this.translationService.translate('admin.partnerOrdersForm.longTitle'),
    );
    ...
    this.actions$
      ...
      .subscribe(() => {
        this.showSuccess(
          this.translationService.translate('admin.partnerOrdersForm.success'),
          this.translationService.translate(
            'admin.partnerOrdersForm.orderDeletedSuccessfully',
          ),
        );
      });
    ...
    this.actions$
      ...
      .subscribe(({ error }) => {
        this.showSuccess(
          this.translationService.translate('admin.partnerOrdersForm.error'),
          this.translationService.translate(
            'admin.partnerOrdersForm.failedToDeleteOrder',
            { error },
          ),
        );
      });
  ...
  private initializeTableConfig(): void {
    this.tableConfig = {
      columns: [
        {
          ...
          label: this.translationService.translate(
            'admin.partnerOrdersForm.orderNumber',
          ),
          type: 'text',
          sortable: true,
          searchable: true,
        },
        {
          key: 'customerEmail',
          label: this.translationService.translate(
            'admin.partnerOrdersForm.customer',
          ),
          type: 'text',
          sortable: true,
          searchable: true,
        ...
        },
        {
          key: 'status',
          label: this.translationService.translate(
            'admin.partnerOrdersForm.status',
          ),
          type: 'status',
          sortable: true,
          searchable: true,
        ...
        },
        {
          key: 'paymentStatus',
          label: this.translationService.translate(
            'admin.partnerOrdersForm.payment',
          ),
          type: 'status',
          sortable: true,
          format: (value) => {
        ...
        },
        {
          key: 'createdAt',
          label: this.translationService.translate(
            'admin.partnerOrdersForm.orderDate',
          ),
          type: 'date',
          sortable: true,
        },
      ...
      actions: [
        ...
        {
          label: this.translationService.translate(
            'admin.partnerOrdersForm.delete',
          ),
          icon: 'trash2',
          action: 'delete',
