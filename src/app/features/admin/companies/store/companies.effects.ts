    ...
    this.actions$.pipe(
      ...
      mergeMap(() =>
        this.companiesService.getCompanies().pipe(
          map((companies) =>
            CompaniesActions.loadCompaniesSuccess({ companies }),
          ),
          catchError((error) => {
      ...
      mergeMap((action) =>
        this.companiesService.approveCompany(action.companyId).pipe(
          switchMap((company) => {
            // Send approval email
            return from(
              this.emailService.sendCompanyApprovalEmail({
              ...
              map(() => {
                this.toastService.showSuccess(
                  'Company approved successfully and notification email sent',
                );
          ...
          catchError((error) => {
            ...
            return of(
              CompaniesActions.approveCompanyFailure({ error: error.message }),
            );
          }),
        ),
      ),
    ...
    this.actions$.pipe(
      ...
      mergeMap((action) =>
        this.companiesService
          .rejectCompany(action.companyId, action.reason)
          .pipe(
            map((company) => {
            ...
            catchError((error) => {
              ...
              return of(
                CompaniesActions.rejectCompanyFailure({ error: error.message }),
              );
            }),
          ),
      ),
      ...
      mergeMap((action) =>
        this.companiesService.deleteCompany(action.companyId).pipe(
          map(() => {
            ...
            return CompaniesActions.deleteCompanySuccess({
          ...
          catchError((error) => {
            ...
            return of(
              CompaniesActions.deleteCompanyFailure({ error: error.message }),
            );
          }),
        ),
      ),
        ...
        this.companiesService
          ...
          .pipe(
            ...
            catchError((error) => {
              ...
              return of(
                CompaniesActions.updateCompanyFailure({ error: error.message }),
              );
            }),
          ),
      ),
