...
export class ReviewsEffects {
      ...
      switchMap(() => {
        return this.supabaseService.client
          ...
          .then(({ data: reviews, error }) => {
            ...
            const mappedReviews: Review[] = (reviews || []).map(
              (review: any) => {
                return {
                  id: review.id,
  ...
  loadReview$ = createEffect(() =>
    this.actions$.pipe(
      ...
      catchError((error: any) =>
        of(ReviewsActions.loadReviewFailure({ error: error.message })),
      ),
    ),
  );
  ...
  updateReviewStatus$ = createEffect(() =>
    this.actions$.pipe(
      ...
      catchError((error: any) => {
        ...
        return of(
          ReviewsActions.updateReviewStatusFailure({ error: error.message }),
        );
      }),
    ),
  );
  ...
  approveReview$ = createEffect(() =>
    this.actions$.pipe(
            ...
            this.supabaseService.client
              ...
              .then(({ data: product, error }) => {
                ...
                return {
                  ...
                  productId,
                  rating,
                  currentCount: product.rating_count || 0,
                  currentAverage: product.rating_average || 0,
                };
              }),
          )
          .then(
            ({ reviewId, productId, rating, currentCount, currentAverage }) => {
      ...
      catchError((error: any) => {
        ...
        return of(
          ReviewsActions.approveReviewFailure({ error: error.message }),
        );
      }),
    ),
  );
    ...
    this.actions$.pipe(
      ...
      switchMap(({ reviewId, review }) => {
        ...
        if (review.adminResponse !== undefined)
          updateData.admin_response = review.adminResponse;
