...
export class TranslationService {
  ...
  private translations: Record<SupportedLanguage, Translations> = {
    hr: {
      ...
      register: {
        ...
        confirmEmailToUnlock:
          'Potvrdite svoju email adresu da biste otvorili sve funkcije SolarShop-a',
        confirmationEmailSentSuccess:
          'Potvrda emaila poslana uspješno! Provjerite svoju inbox.',
        ...
        emailVerificationFailed:
          'Potvrđivanje nije uspjelo. Molimo pokušajte ponovno.',
        invalidVerificationLink:
          'Nevažeća ili istekla poveznica za potvrđivanje.',
      ...
      partnersRegister: {
        ...
        applicationMessage:
          'Vaš zahtjev za partnerstvo je poslan na pregled. Kontaktirat ćemo vas uskoro.',
      ...
      b2b: {
        ...
        about: {
          ...
          heroSubtitle:
            'Otkrijte ekskluzivne prednosti, posebne cijene i podršku za vaš biznis u solarnoj industriji',
          benefits: 'Prednosti partnerstva',
          exclusivePricing: 'Ekskluzivne cijene',
          exclusivePricingText:
            'Pristup posebnim cijenama i popustima za partnere.',
          pricingTitle: 'Posebne cijene za partnere',
          pricingSubtitle:
            'Ostvarite značajne uštede s našim partnerskim cijenama',
          pricingDescription:
            'Kao naš partner, dobivate pristup ekskluzivnim cijenama nižim od standardnih cijena. Vaše uštede se povećavaju s volumenom narudžbi.',
          pricingBenefits: {
            volumeDiscounts: 'Popusti na količinu',
            volumeDiscountsText: 'Veći popusti za veće narudžbe',
            tierPricing: 'Cjenovni razredi',
            tierPricingText:
              'Posebni cjenovni razredi ovisno o statusu partnera',
          ...
          supportDescription:
            'Naš tim stručnjaka je dostupan za sve vaše potrebe. Od tehničkih pitanja do pomoći s narudžbama, tu smo za vas.',
          supportBenefits: {
            ...
            technicalSupportText: 'Tehnička podrška od stručnjaka',
          ...
          marketingSupportText:
            'Materijali za marketing i podrška u promociji.',
          marketingTitle: 'Marketing i edukacija',
          marketingSubtitle: 'Proširite svoj biznis s našom podrškom',
          marketingDescription:
            'Pružamo vam sve potrebne materijale i obuku za uspješno predstavljanje naših proizvoda vašim kupcima.',
          marketingBenefits: {
          ...
          requirementsText:
            'Saznajte što trebate za postajanje našeg partnera.',
          requirementsTitle: 'Uvjeti za partnerstvo',
          requirementsSubtitle: 'Jednostavan proces postajanja partnera',
          requirementsDescription:
            'Naš proces partnerstva je osmišljen da bude jednostavan i transparentan. Evo što trebate:',
          ...
          commitmentText:
            'Predanost pružanju visokokvalitetnih usluga kupcima.',
          ...
          startApplicationToday:
            'Počnite s prijavljeniem danas i otključajte ekskluzivne prednosti za vaš biznis.',
        ...
        contact: {
          ...
          partnerSupportText:
            'Podrška za partnere je dostupna da vam pomogne s bilo kojim pitanjima ili problemima.',
          ...
          salesTeamText:
            'Naš prodajni tim je dostupan da vam pomogne s bilo kojim pitanjima ili problemima.',
          salesTeamEmail: 'prodaja@solarni-paneli.hr',
          salesTeamPhone: '+385 (1) 6407 715',
          technicalSupport: 'Tehnička podrška',
          technicalSupportText:
            'Naš tehnički tim je dostupan da vam pomogne s bilo kojim pitanjima ili problemima.',
          technicalSupportEmail: 'webshop@solarno.hr',
          technicalSupportPhone: '+385 (1) 6407 715',
          supportEmail: 'prodaja1@solarni-paneli.hr',
        ...
        products: {
          ...
          companyNotApprovedMessage:
            'Molimo prijavite se za partnerstvo ili kontaktirajte naš tim za podršku',
          ...
          pendingPriceMessage:
            'Kontaktirajte nas za specifičnu cijenu za vašu tvrtku',
          ...
          tryAdjustingFilters:
            'Pokušajte prilagoditi filtere ili pojmove pretrage.',
          ...
          pricing: 'Cijena',
          signInToViewPricing:
            'Prijavite se za pregled posebnih partnerskih cijena',
        ...
        auth: {
          ...
          partnerVerificationRequired:
            'Potrebna je provjera partnera za pregled ekskluzivnih ponuda',
          becomePartner: 'Postanite partner',
          partnerVerificationRequiredPricing:
            'Potrebna je provjera partnera za pregled cijena',
        ...
        offers: {
          ...
          noPartnerPricingAvailable:
            'Partnerska cijena nije dostupna za ovaj proizvod',
          quantityTierPricing: 'Cijena po količini',
          productDiscount: 'Popust proizvoda',
          percentageDiscountDescription:
            'Postotni popust primijenjen na ovaj proizvod',
          yourPrice: 'Vaša cijena',
          ...
          contactSupportForPricingDescription:
            'Kontaktirajte našu podršku za informacije o cijenama i posebnim uvjetima partnerstva.',
          offerNotAvailable: 'Ponuda nije dostupna',
          noPartnerPricingForAnyProduct:
            'Partnerska cijena nije dostupna za nijedan proizvod u ovoj ponudi',
          productsWithPricing: 'Proizvodi s partnerskom cijenom',
          categoryDiscount: 'Kategorijski popust',
          categoryDiscountDescription:
            'Ovaj popust se odnosi na cijelu kategoriju proizvoda',
          discount: 'popust',
          ...
          offerClaimedWithProducts:
            'Ponuda "{{title}}" je preuzeta - dodano {{count}} proizvoda u košaricu!',
          useCouponCode: 'Koristite kod kupona: {{code}}',
          couponAppliedAutomatically:
            'Kod kupona {{code}} je automatski primijenjen.',
          itemsOutOfStock: '{{count}} stavka je nedostupno.',
          offerClaimedButOutOfStock:
            'Ponuda "{{title}}" je preuzeta, ali svi proizvodi su rasprodani.',
          ...
          generalOfferDescription:
            'Ova ponuda se odnosi na cijeli katalog proizvoda',
          ...
          bundleRequiresAllProductsInCart:
            'Svi proizvodi moraju biti u košarici za primjenu popusta',
        },
        profile: {
          ...
          accessDeniedMessage:
            'Nemate ovlasti za pristup ovoj stranici. Trebate biti odobren partner.',
          ...
          noOrdersFoundMessage:
            'Počnite kupovati da biste vidjeli vaše narudžbe ovdje.',
      ...
      b2bCart: {
        ...
        emptyMessage:
          'Dodajte proizvode u košaricu da biste nastavili s narudžbom',
        ...
        minimumOrderViolation:
          'Neki proizvodi ne ispunjavaju minimalne uvjete narudžbe',
        ...
        minimumOrderRequired:
          'Minimalna narudžba: {{minimum}} komada (trenutno: {{current}})',
        productAdded: 'Dodan {{name}} u vašu košaricu!',
        additionalOfferSavings: 'Dodatna ušteda ponude',
        tier: 'Razina',
        qty: 'Kom',
        addMoreForTier:
          'Dodajte još {{qty}} kom za cijenu €{{price}} (ušteda €{{savings}})',
      },
      ...
      b2bCheckout: {
        ...
        paymentUponCollection: 'Plaćanje po preuzimanju',
        paymentUponCollectionDescription:
          'Platite kada preuzmete robu u našoj trgovini',
        specialInstructions: 'Posebne instrukcije',
        specialInstructionsPlaceholder:
          'Bilo koji posebni zahtjevi ili napomene za vašu narudžbu...',
        ...
        bankTransferDescription:
          'Transfer sredstava direktno na naš bankovni račun',
        creditTermsDescription:
          'Plaćanje u roku od 30 dana od izdavanja računa',
        businessOrder: 'Poslovna narudžba',
        businessOrderDescription:
          'Ova narudžba će biti obrađena kao B2B transakcija',
      ...
      admin: {
        ...
        orderDiscountNote:
          'Popust se primjenjuje na ukupnu vrijednost narudžbe',
        orderSummary: 'Sažetak narudžbe',
        ...
        productPriceRequired:
          'Cijena proizvoda je obavezna i mora biti veća od 0',
        ...
        productDimensionsHelp:
          'Unesite dimenzije u formatu: duljina x širina x visina jedinica (npr. 100x50x20cm, 10x5x2m, 1000x500x200mm)',
        productStatus: 'Status proizvoda',
        productImages: 'Slike',
        productAlreadyExists: 'Proizvod {{name}} već postoji',
        productEnterOneImageUrlPerLine:
          'Unesite jednu URL adresu slike po retku',
        productImage: 'Slika',
        productStock: 'Zalihe',
        productSpecifications: 'Specifikacije',
        productSpecificationsHelp:
          'Unesite jednu specifikaciju po retku (npr. Frekvencija: 50Hz, Napon: 230V)',
        productFeatures: 'Značajke',
        productFeaturesHelp:
          'Unesite jednu značajku po retku (npr. Dual MPPT trackers, WiFi monitoring)',
        productCertifications: 'Certifikati',
        productCertificationsHelp:
          'Unesite jedan certifikat po retku (npr. IEC 61215, IEC 61730)',
        productTechnicalSheet: 'Tehnički list',
        productTechnicalSheetHelp:
          'URL do tehničke dokumentacije proizvoda (npr. PDF s tehničkim specifikacijama)',
        ...
        productRelationshipsNoRelationshipsDescription:
          'Nema povezanih proizvoda. Dodajte proizvode za povezivanje.',
        ...
        productImportError:
          'Greška prilikom unosa proizvoda. Molimo provjerite format CSV datoteke.',
        ...
        categoriesForm: {
          ...
          errorImportingCategories:
            'Greška prilikom učitavanja kategorija. Molimo provjerite format CSV datoteke.',
          ...
          categoryHasRelatedProducts:
            'Kategorija se ne može obrisati jer sadrži povezane proizvode. Prvo uklonite sve proizvode iz ove kategorije.',
        ...
        blogForm: {
          ...
          markdownFormatting:
            'Možete koristiti Markdown formatiranje za bogati tekst',
        ...
        companiesForm: {
          ...
          noCompaniesFoundDescription:
            'Trenutno nema tvrtki koje odgovaraju vašim kriterijima pretraživanja.',
          basicInformation: 'Osnovne informacije',
          ...
          confirmRejectionMessage:
            'Jeste li sigurni da želite odbiti ovu tvrtku?',
          confirmApprove: 'Jeste li sigurni da želite odobriti ovu tvrtku?',
          confirmApprovalTitle: 'Odobravanje tvrtke',
          confirmApprovalMessage: 'Jeste li sigurni da želite odobriti tvrtku',
          approveCompany: 'Odobri tvrtku',
          approvalNote:
            'Odobravanje će omogućiti tvrtki pristup B2B funkcionalnostima i prilagođenim cijenama.',
          confirmDeletion: 'Potvrdi brisanje',
          confirmDeletionMessage:
            'Jeste li sigurni da želite obrisati ovu tvrtku?',
          companyApplications: 'Zahtjevi za partnerstvo',
          companyApplicationsDescription:
            'Upravljajte zahtjevima za partnerstvo',
          noDataFoundInCsvFile: 'Nema podataka u CSV datoteci',
          errorImportingCompanies:
            'Greška prilikom učitavanja tvrtki. Molimo provjerite format CSV datoteke.',
        },
        companyPricingForm: {
          ...
          errorDeletingPricing:
            'Greška prilikom brisanja cijena tvrtke. Molimo pokušajte ponovno.',
          ...
          selectMultipleCategories:
            'Držite Ctrl (Cmd) za odabir više kategorija',
          ...
          priceOverrideNote:
            'Ova cijena će zamijeniti standardnu cijenu proizvoda za ovu tvrtku',
          importantNotes: 'Važne napomene',
          noteSpecificPricing:
            'Tvrtka-specifična cijena ima prednost nad standardnom cijenom proizvoda',
          noteFutureOrders:
            'Promjene će utjecati na sve buduće narudžbe za ovu tvrtku',
          noteExistingOrders:
            'Postojeće narudžbe neće biti pogođene promjenama cijena',
          productName: 'Naziv proizvoda',
          ...
          bulkDiscountHint:
            'Grupni popust omogućuje vam postavljanje popusta na više proizvoda odjednom.',
          discount: 'popust',
          // Alert messages
          confirmBulkDiscountAll:
            'Primijeni {{percentage}}% popust na SVE tvrtke i SVE proizvode? Ovo će ažurirati sve postojeće cijene.',
          bulkDiscountAppliedAll:
            'Grupni popust od {{percentage}}% primijenjen na svih {{count}} proizvoda',
          bulkDiscountAppliedFiltered:
            'Grupni popust od {{percentage}}% primijenjen na {{count}} filtriranih proizvoda',
          errorSavingPricing:
            'Greška prilikom spremanja promjena cijena. Molimo pokušajte ponovno.',
          ...
          errorImportingCsv:
            'Greška prilikom uvoza CSV datoteke. Molimo provjerite konzolu za detalje i pokušajte ponovno.',
          noCompanyPricingDataToExport:
            'Nema podataka o cijenama tvrtki za izvoz',
          noPricingRecordsFoundToUpdate:
            'Nisu pronađeni zapisi cijena za ažuriranje',
          errorExportingCompanyPricing:
            'Greška prilikom izvoza podataka o cijenama tvrtki. Molimo pokušajte ponovno.',
          successfullyDeletedAllCustomPricing:
            'Uspješno obrisane sve prilagođene cijene za {{companyName}}',
          errorDeletingCompanyPricing:
            'Greška prilikom brisanja cijena tvrtke. Molimo pokušajte ponovno.',
          // Bulk discount loading messages
          bulkDiscountProcessing: 'Procesiranje grupnog popusta...',
          bulkDiscountProgress:
            'Obrađeno {{current}} od {{total}} kombinacija tvrtki-proizvoda',
          bulkDiscountCompleted:
            'Grupni popust uspješno primijenjen na {{count}} kombinacija',
          confirmBulkDiscountCompany:
            'Primijeni {{percentage}}% popust na sve proizvode za ovu tvrtku?',
          confirmBulkDiscountFiltered:
            'Primijeni {{percentage}}% popust na {{count}} filtriranih proizvoda?',
          confirmClearAllPricing:
            'Jeste li sigurni da želite obrisati sve prilagođene cijene za ovu tvrtku?',
        },
        ...
        contactsForm: {
          title: 'Reklamacije',
          subtitle: 'Upravljajte reklamacijama od kupaca',
        ...
        offersForm: {
          ...
          leaveEmptyForUnlimitedUsage:
            'Ostavi prazno za neograničeno korištenje',
          priority: 'Prioritet',
          ...
          selectCategory: 'Odaberi kategoriju',
          categoryTooltip:
            'Odabir kategorije će filtrirati listu proizvoda samo za tu kategoriju',
          applyToCategory: 'Primijeni na cijelu kategoriju',
          applyToCategoryTooltip:
            'Označite da primijenite popust na sve proizvode u odabranoj kategoriji',
          individualProducts: 'Pojedinačni proizvodi',
          individualProductsTooltip:
            'Dodajte proizvode pojedinačno s različitim popustima',
          categoryDiscount: 'Popust kategorije',
          categoryDiscountTooltip:
            'Popust koji će se primijeniti na sve proizvode u kategoriji',
          ...
          categoryChangePrompt:
            'Imate {{count}} proizvod(a) koji nisu u odabranoj kategoriji "{{categoryName}}". Želite li ih ukloniti i zadržati samo proizvode iz ove kategorije?',
          categoryChangePromptTitle: 'Promjena kategorije',
          categoryChangePromptMessage:
            'Odabir nove kategorije će filtrirati dostupne proizvode. Želite li ukloniti postojeće proizvode koji nisu u ovoj kategoriji?',
          allCategoryProductsAdded:
            'Svi proizvodi iz ove kategorije su već dodani u ponudu.',
          productNotInSelectedCategory:
            'Ovaj proizvod ne pripada odabranoj kategoriji.',
          ...
          distributeDiscountAcross:
            'Postavi {{amount}}€ popust na sve proizvode',
          distributeDiscount: 'Postavi popust',
          totalProductDiscountsExceed:
            'Popusti proizvoda će se podudarati sa globalnim popustom od {{amount}}€',
          locked: 'Zaključano',
          matchesGlobalDiscount: 'Podudara se sa globalnim popustom',
          autoSetToMatchGlobalDiscount:
            'Automatski postavljeno da se podudara sa globalnim popustom',
          productDiscountMustMatch:
            'Popust proizvoda mora biti točno {{type}}{{value}} da se podudara sa globalnim popustom ponude',
          bundleConfiguration: 'Konfiguracija paketa',
          bundleOffer: 'Paketna ponuda',
          bundleOfferDescription:
            'Paketna ponuda zahtijeva kupnju svih proizvoda zajedno',
          bundleOfferNotice: 'Napomena o paketnoj ponudi',
          bundleRequiresAllProducts:
            'Paketna ponuda zahtijeva kupnju svih proizvoda',
          bundleDiscountAppliedOnlyWhenComplete:
        ...
        wishlistForm: {
          ...
          notImplementedDescription:
            'Wishlist management is currently not available. This feature will be added in future versions.',
          enterName: 'Unesite svoje ime',
          enterEmail: 'Unesite svoj email',
          enterCompany: 'Unesite naziv tvrtke',
          enterMessage: 'Unesite svoju poruku',
          ...
          noWishlistItemsDescription:
            'Ovaj korisnik još nije dodao stavke na svoju listu želja.',
          viewProduct: 'Pogledaj proizvod',
          remove: 'Ukloni',
          added: 'Dodano',
          close: 'Zatvori',
          confirmRemoveItem:
            'Jeste li sigurni da želite ukloniti ovu stavku s liste želja?',
          confirmDeleteAllItems:
            'Jeste li sigurni da želite obrisati sve stavke liste želja za',
        ...
        usersForm: {
          ...
          csvImportDisabled:
            'CSV uvoz je onemogućen za upravljanje korisnicima iz sigurnosnih razloga',
        },
        ordersForm: {
          title: 'Narudžbe',
        ...
        partnerOrdersForm: {
          ...
          confirmOrderDeletion: 'Potvrdi brisanje narudžbe',
          confirmOrderDeletionMessage:
            'Jeste li sigurni da želite obrisati ovu narudžbu partnera? Ova akcija se ne može poništiti.',
        ...
        common: {
          ...
          thisMonth: 'Ovaj mjesec',
          noTemplateAvailable:
            'Nema dostupnih podataka za preuzimanje CSV uzorka',
          getStartedByCreating: 'Započnite s kreiranjem sada...',
          noResults: 'Nema rezultata',
          confirmDeletion: 'Potvrdi brisanje',
          confirmDeleteMessage:
            'Jeste li sigurni da želite obrisati "{{itemName}}"? Ova radnja se ne može poništiti.',
          thisItem: 'ovu stavku',
          savingChanges: 'Spremanje promjena...',
          allChangesSaved: 'Sve promjene uspješno spremljene!',
          errorSavingChanges:
            'Greška prilikom spremanja promjena. Molimo pokušajte ponovno.',
          orderStatusChangeMessage:
            'Status narudžbe označen za promjenu sa "{{oldStatus}}" na "{{newStatus}}". Kliknite "Spremi promjene" za primjenu.',
          paymentStatusChangeMessage:
            'Status plaćanja označen za ažuriranje. Kliknite "Spremi promjene" za primjenu.',
          invoicePrintingInitiated:
            'Ispis računa za narudžbu {{orderNumber}} uspješno pokrenut!',
          showing: 'Prikazano',
          to: 'do',
          of: 'od',
          results: 'rezultata',
      ...
      adminCompanyPricing: {
        ...
        priceDescription:
          'Unesite prilagođenu cijenu u eurima za ovaj proizvod i tvrtku',
        additionalInfo: 'Dodatne informacije',
        importantNotes: 'Važne napomene',
      ...
      sortOptions: {
        ...
        noSortOptionsDescription:
          'Dodajte opcije sortiranja kako bi korisnici mogli sortirati proizvode.',
        deleteSortOption: 'Obriši opciju sortiranja',
        confirmDelete:
          'Jeste li sigurni da želite obrisati ovu opciju sortiranja?',
        ...
        sortFieldsHint:
          'Dodajte jedno ili više polja po kojima će se sortirati. Redoslijed je važan - sortira se prvo po prvom polju, zatim po drugom itd.',
      ...
      reviewsSection: {
        ...
        mustPurchaseFirst:
          'Možete pisati recenzije samo za proizvode koje ste kupili i primili.',
        ...
        reviewSubmittedMessage:
          'Hvala vam na recenziji. Bit će objavljena nakon odobrenja administratora.',
        reviewError: 'Greška',
        reviewErrorMessage:
          'Neuspješno slanje recenzije. Molimo pokušajte ponovno.',
      },
      // Profile
      profile: {
        profile: 'Profil',
        ...
        updatePersonalDetails:
          'Ažurirajte svoje osobne podatke i kontakt informacije',
        ...
        manageReviews:
          'Upravljajte svojim recenzijama i pogledajte odgovore admina',
        verifiedPurchase: 'Potvrđena kupnja',
        ...
        writeFirstReview:
          'Napišite svoju prvu recenziju nakon kupovine proizvoda',
        qty: 'Kol.',
      },
      // Admin Wishlist
      adminWishlist: {
        ...
        noWishlistItemsDescription:
          'Ovaj korisnik još nema stavki u svojoj listi želja.',
        added: 'Dodano',
        viewProduct: 'Pogledaj proizvod',
        remove: 'Ukloni',
        close: 'Zatvori',
      ...
      products: {
        title: 'Kategorije',
        subtitle:
          'Otkrijte naš široki asortiman proizvoda za održivu i energetski učinkovitu gradnju',
        exploreProducts: 'Istražite proizvode',
        productsCount: 'Broj proizvoda: {{count}}',
        needHelp: 'Trebate pomoć u odabiru?',
        needHelpText:
          'Naši stručnjaci su tu da vam pomognu pronaći savršene proizvode za vaš projekt. Zatražite personalizirane preporuke već danas.',
      ...
      offers: {
        ...
        subtitle:
          'Otkrijte nevjerojatne uštede na solarnim sustavima i komponentama',
        allCategories: 'Sve kategorije',
        solarPanels: 'Solarni paneli',
        ...
        noOffersText:
          'Trenutno nema aktivnih ponuda. Provjerite našu ponudu proizvoda.',
        browseAllProducts: 'Pregledaj sve proizvode',
        dontMissOut: 'Ne propustite!',
        subscribeText:
          'Pretplatite se na naš newsletter i budite prvi koji će saznati o novim ponudama.',
        ...
        defaultDescription:
          'Ova ponuda uključuje odabrane proizvode po sniženim cijenama. Iskoristite priliku i uštedite na vašem sljedećem solar projektu.',
        ...
        allProductsOutOfStock: 'Svi proizvodi su trenutno rasprodani.',
        failedToAddProducts:
          'Neuspješno dodavanje proizvoda u košaricu. Molimo pokušajte ponovno.',
        errorAddingProducts:
          'Greška prilikom dodavanja proizvoda u košaricu. Molimo pokušajte ponovno.',
      },
      // Mission/Sustainability
      mission: {
        title: 'Održivost',
        subtitle:
          'Za nas u SolarShopu održivi pristup znači više od same zaštite okoliša - uključuje odgovorno korištenje resursa, ekonomski isplativa rješenja za klijente i stvaranje dugoročnih vrijednosti za društvo.',
        ourPhilosophy: 'Naša filozofija',
        environmentalResponsibility: 'Odgovornost prema okolišu',
        environmentalText:
          'Svaki naš projekt ima cilj smanjiti emisije i potaknuti korištenje obnovljivih izvora energije, stvarajući čišću i održiviju budućnost.',
        qualityDurability: 'Kvaliteta i trajnost',
        qualityText:
          'Gradimo solarne sustave koji su pouzdani, dugotrajni i prilagođeni stvarnim potrebama naših klijenata.',
        technologicalInnovation: 'Tehnološka inovacija',
        innovationText:
          'Neprestano uvodimo nove tehnologije i rješenja kako bismo povećali učinkovitost i osigurali da naši klijenti dobiju najmodernija solarna rješenja dostupna na tržištu.',
        commitmentBeyond:
          'U SolarShopu vjerujemo da naša uloga nadilazi samu isporuku solarnih sustava',
        personalizedConsulting: 'Edukacija kupaca',
        consultingText:
          'Pružamo stručne informacije i savjete kako bi naši klijenti mogli maksimalno iskoristiti svoje solarne sustave i razumjeli sve prednosti obnovljive energije.',
        continuousUpdates: 'Odgovorno poslovanje',
        updatesText:
          'Svaki naš projekt provodimo transparentno i odgovorno, vodeći računa o okolišu, sigurnosti i dugoročnoj održivosti.',
        awarenessEducation: 'Podrška zajednici',
        educationText:
          'Angažirani smo u lokalnim zajednicama, promičemo održive prakse i gradimo dugoročne odnose temeljene na povjerenju i suradnji.',
        materialSelection: 'Kako biramo materijale',
        rawMaterialsAnalysis: 'Analiza sirovina',
        rawMaterialsText:
          'Dajemo prioritet obnovljivim, recikliranim ili reciklabilnim materijalima, izbjegavajući tvari štetne za zdravlje i ekosustav.',
        certificationEvaluation: 'Evaluacija certifikata',
        certificationText:
          'Prije predlaganja proizvoda, provjeravamo njegove certifikate za okoliš i kvalitetu, kao što su LEED, CasaClima, FSC, PEFC ili ISO 14001.',
        energyEfficiency: 'Energetska učinkovitost',
        efficiencyText:
          'Biramo proizvode i rješenja koja poboljšavaju toplinsku izolaciju, smanjuju potrošnju i pogoduju korištenju obnovljivih izvora energije.',
        subscribeNewsletter: 'Pretplatite se na naš newsletter',
        subscribe: 'Pretplatite se',
        callToAction:
          'Zajedno možemo izgraditi budućnost u kojoj udobnost, kvaliteta, učinkovitost i poštovanje okoliša idu ruku pod ruku. Odabirom SolarShop-a, odlučujete doprinijeti zdravijem, uravnoteženjem i svjesnijem svijetu.',
      },
      ...
      blog: {
        ...
        recentProjectsSubtitle:
          'Otkrijte najnovije solar projekte, tehničke uvide i stručne savjete našeg tima',
        ...
        technicalGuidesText:
          'Detaljni vodiči za instalaciju, održavanje i optimizaciju solarnih sustava.',
        regulationsInsights: 'Uvidi u propise',
        regulationsText:
          'Najnovije informacije o solarnim poticajima, zakonima i regulativama.',
        sustainabilityTips: 'Savjeti za održivost',
        sustainabilityText:
          'Praktični savjeti za zelji život i maksimalizaciju energetske učinkovitosti.',
        caseStudies: 'Studije slučaja',
        caseStudiesText:
          'Stvarni primjeri uspješnih solarnih instalacija i njihovih rezultata.',
        ...
        partnerText:
          'Više od 10 godina iskustva u solarnoj industriji. Naš tim stručnjaka dijeli znanje kroz informativne članke koji vam pomažu donijeti prave odluke.',
      ...
      company: {
        ...
        subtitle:
          'Dobrodošli u sekciju posvećenu našoj kompaniji. Ovdje možete saznati više o nama, našoj povijesti, vrijednostima i timu.',
        whoWeAre: 'Tko smo mi',
        whoWeAreText:
          'Tvrtka Hvaljen budi d.o.o. je osnovana 2011. godine u Zagrebu i od tada posluje pod brendom SolarShop. Od samog početka definirali smo i obilježili područje naše djelatnosti, potpuno se posvećujući solarnoj energiji, obnovljivim izvorima i zelenoj tranziciji. Pozicionirali smo se kao tržišni lideri i postali konkurentan pružatelj solarnih oprema, nudeći najširi asortiman svih potrebnih komponenti za fotonaponske elektrane.',
        mission:
          'Naša misija je jednostavna: učiniti dostupnim svima najnovija rješenja za proizvodnju električne energije iz obnovljivih izvora, s naglaskom na solarnu energiju. Naš cilj je omogućiti svakome da postane energetski neovisan i doprinese smanjenju emisije CO2.',
        ourTeam: 'Cilj',
        teamText1:
          'Odlučniji smo nego ikad da održimo postavljene ciljeve, da tržištu predstavimo koncept solarne energije i da instaliramo solarne elektrane na što više krovova, kako za pojedince tako i za pravne subjekte, poput tvornica, skladišta, crkava i drugih javnih i društveno korisnih ustanova.',
        teamText2:
          'Sinergijom kvalitetnih proizvoda, uvijek birajući provjerene i renomirane proizvođače, i stalnim proširivanjem našeg asortimana komplementarnim proizvodima, zajedno s brzom, profesionalnom i efikasnom uslugom instalacije, postali smo neophodan i poželjan partner za svakoga tko želi proizvoditi električnu energiju. Kontinuiranim zapošljavanjem kvalificiranog osoblja i ulaganjem u postojeće, osiguravamo da smo u korak s tehnologijom i pružamo našim kupcima i korisnicima 24-satnu tehničku podršku i uslugu.',
        teamText3:
          'Danas, zbog svega navedenog, možemo ponuditi rješenja "ključ u ruke", bez obzira radi li se o jednostavnim kućnim solarnim elektranama, elektranama na proizvodnim objektima, trgovačkim centrima, tvornicama ili elektranama na tlu, poznatim i kao solarna polja. Naš tim preuzima cijeli proces: od razvoja projekta, isporuke komponenti, instalacije elektrane, upravljanja svom dokumentacijom, komunikacije s relevantnim tijelima, do, konačno, puštanja elektrane u pogon.',
        teamText4:
          'Naša je misija pospješiti energetsku tranziciju pružanjem pouzdanih, pristupačnih i ekološki prihvatljivih solarnih rješenja. Kroz inovaciju i predanost težimo biti prepoznati lider u izgradnji solarnih elektrana te omogućiti svakome pristup čistoj i obnovljivoj energiji.',
        missionValues: 'Misija i vrijednosti',
        quality: 'Kvaliteta',
        qualityText:
          'Nudimo kvalitetne i pouzdane proizvode, odabrane od provjerenih proizvođača kako bi svojim klijentima omogućili najoptimalnija rješenja.',
        innovation: 'Inovacija',
        innovationText:
          'Ne prestajemo tražiti nova rješenja, tehnologije i pristupe kako bismo unaprijedili učinkovitost i vrijednost solarnih sustava koje nudimo.',
        sustainability: 'Održivost',
        sustainabilityText:
          'Poštujemo planet tako što svakim projektom nastojimo smanjiti negativan utjecaj na okoliš i potaknuti dugoročno odgovorno korištenje resursa.',
        support: 'Podrška',
        supportText:
          'Pratimo Vas u svakoj fazi, od odabira proizvoda do postprodajne pomoći., sve kako bismo maksimizirali Vašu korist i zadovoljstvo.',
        suppliersPartners: 'Dobavljači i partneri',
        partnersText:
          'Surađujemo s najutvrđenijim markama i specijaliziranim kompanijama.',
        socialResponsibility: 'Društvena i ekološka odgovornost',
        responsibilityText:
          'Naša predanost ne prestaje na proizvodu. Predani smo promicanju kulture održivosti.',
      },
      // Cart
      cart: {
        title: 'Vaša košarica',
        ...
        apply: 'Primijeni',
        singleCouponLimit:
          'Samo jedan kupon može biti primijenjen u isto vrijeme.',
        subtotal: 'Ukupno',
        tax: 'Porez',
        shipping: 'Dostava',
        discount: 'Popust',
        ...
        couponValidationError:
          'Neuspješna provjera kupona. Molimo pokušajte ponovno.',
        ...
        couponCannotApplyToDiscountedProducts:
          'Ovaj kupon se ne može primijeniti na već snižene proizvode',
        couponMinOrderNotMet:
          'Potreban je minimalni iznos narudžbe od €{{amount}} za ovaj kupon',
        couponMaxOrderExceeded:
          'Prekoračen je maksimalni iznos narudžbe od €{{amount}} za ovaj kupon',
        couponNotApplicableToOffers:
          'Ovaj kupon se ne može primijeniti na ponude u vašoj košarici',
        couponExcludedFromOffers:
          'Ovaj kupon se ne može koristiti s ponudama u vašoj košarici',
        couponNotApplicableToProducts:
          'Ovaj kupon se ne može primijeniti na proizvode u vašoj košarici',
        couponExcludedFromProducts:
          'Ovaj kupon se ne može koristiti s nekim proizvodima u vašoj košarici',
        couponNotApplicableToCategories:
          'Ovaj kupon se ne može primijeniti na kategorije proizvoda u vašoj košarici',
        couponExcludedFromCategories:
          'Ovaj kupon se ne može koristiti s nekim kategorijama proizvoda u vašoj košarici',
        ...
        bundleRequiresAllProducts:
          'Svi proizvodi iz paketne ponude moraju biti u košarici da biste primijenili popust.',
      },
      // 404 Not Found
      notFound: {
        title: 'Stranica nije pronađena',
        description:
          'Nažalost, stranica koju tražite ne postoji ili je premještena. Molimo provjerite URL ili se vratite na početnu stranicu.',
      ...
      checkout: {
        ...
        pickupAtStorageDescription:
          'Preuzmite svoju narudžbu izravno iz našeg skladišta. Besplatno i dostupno radnim danima.',
        paymentMethod: 'Način plaćanja',
        payOnDeliveryDescription:
          'Plaćanje pouzećem. Kupac plaća nakon dostave proizvoda.',
        creditCardDescription:
          'Vaša kartica će biti sigurno obrađena. Sve informacije o kartici su šifrirane.',
        guestCheckout: 'Kupac bez računa',
        guestCheckoutDescription:
          'Kupac može dovršiti narudžbu bez stvaranja računa. Narudžba će biti obrađena i kupac će primiti potvrdu putem emaila.',
        ...
        businessOrderDescription:
          'Označite ovu opciju za poslovne kupnje s mogućnostima posebnih cijena, fakturiranja i prioritetne podrške.',
        bulkDiscounts: 'Količinski popusti',
        prioritySupport: 'Prioritetna podrška',
        customInvoicing: 'Posebno fakturiranje',
        oneOrMoreItemsUnavailable:
          'Jedan ili više proizvoda u vašoj košarici nije dostupan u traženoj količini. Molimo provjerite vašu košaricu i pokušajte ponovno.',
        securePayment: 'Sigurno plaćanje',
        securePaymentDescription:
          'Detalji Vaše kartice bit će sigurno uneseni na Monri platformi za plaćanje.',
        orderingDisabled: 'Narudžbe trenutno nisu dostupne',
        orderingDisabledDescription:
          'Naručivanje je trenutno onemogućeno. Molimo pokušajte ponovno kasnije ili nas kontaktirajte za više informacija.',
      },
      // Payment
      payment: {
        processing: 'Obrađujemo vaše plaćanje...',
        processingDescription:
          'Molimo sačekajte dok obrađujemo vašu transakciju. Ovo može potrajati nekoliko trenutaka.',
        success: 'Plaćanje uspješno!',
        successDescription:
          'Vaše plaćanje je uspješno obrađeno i narudžba je potvrđena.',
        failed: 'Plaćanje neuspješno',
        failedDescription:
          'Nažalost, vaše plaćanje nije uspješno obrađeno. Molimo pokušajte ponovno.',
        cancelled: 'Plaćanje otkazano',
        cancelledDescription:
          'Plaćanje je otkazano. Možete pokušati ponovno ili se vratiti u košaricu.',
        orderNumber: 'Broj narudžbe',
      ...
      orderConfirmation: {
        ...
        description:
          'Hvala vam na kupovini! Vaša narudžba je uspješno kreirana i bit će obrađena u najkraćem roku.',
        orderNumber: 'Broj narudžbe',
      ...
      orderDetails: {
        ...
        orderNotFoundMessage:
          'Narudžba koju tražite nije mogla biti pronađena.',
        orderNumber: 'Broj narudžbe',
        status: 'Status',
        payment: 'Plaćanje',
        total: 'Ukupno',
        ...
        contactForQuestions:
          'Za sva pitanja o ovoj narudžbi, kontaktirajte nas na',
        email: 'Email',
        phone: 'Telefon',
      },
      // Footer
      footer: {
        companyDescription:
          'Mi smo Solar Shop, tvrtka specijalizirana za moderna i pouzdana solarna rješenja. Pružamo prodaju i ugradnju kvalitetnih solarnih sustava te stručno savjetovanje. Naš cilj je omogućiti klijentima jednostavan prelazak na čistu energiju i dugoročne uštede.',
        address: 'Bani ul. 73, 10010, Buzin, Hrvatska',
        phone: '+385 (1) 6407 715',
        email: 'webshop@solarno.hr',
        ...
        newsletterDescription:
          'Budite u toku s najnovijim proizvodima i ponudama.',
        subscribe: 'Pretplatite se',
      ...
      safetyPayment: {
        ...
        creditCardSecurity: {
          ...
          intro:
            'Tajnost Vaših podataka je zaštićena i osigurana upotrebom SSL enkripcije.',
          sslDescription:
            'Stranice za naplatu putem interneta osigurane su korištenjem Secure Socket Layer (SSL) protokola sa 128-bitnom enkripcijom podataka. SSL enkripcija je postupak šifriranja podataka radi sprječavanja neovlaštenog pristupa prilikom njihovog prenosa.',
          dataTransfer:
        ...
        privacyStatement: {
          ...
          dataAccess:
            'Svi se podaci o korisnicima strogo čuvaju i dostupni su samo zaposlenicima kojima su ti podaci nužni za obavljanje posla.',
          employeeResponsibility:
            'Svi naši zaposlenici i poslovni partneri odgovorni su za poštivanje načela zaštite privatnosti.',
        },
        termsOfUse: {
          title: 'Uslovi korištenja',
          ownership:
            'ONLINE WEB SHOP (solarno.hr) je u vlasništvu firme Hvaljen buid d.o.o.. Putem ONLINE WEB SHOPA nudimo usluge pružanja informacija te online naručivanja i kupovine proizvoda.',
          availability:
            'ONLINE WEB SHOP je aktivan 24h dnevno, svaki dan u godini. Pristup online trgovini može biti povremeno onemogućen radi održavanja ili eventualnih tehničkih problema.',
          compliance:
            'solarno.hr kao pružatelj usluga pridržava se zakonskih propisa sa ciljem zaštite privatnosti korisnika, a uslovi korištenja napravljeni su u skladu sa međunarodnim običajima online poslovanja.',
          pricing:
            'Cijene navedene na ONLINE SHOP-u izražene su u valuti eura (EUR), međunarodne oznake EUR. Cijene su maloprodajne, sa uračunatim PDV-om, a važeća cijena je ona cijena navedena u trenutku primanja narudžbe.',
          payment:
            'Za kartično plaćanje na rate ili druge načine plaćanja, su pune cijene u ovom slučaju (prekrižene cijene) iznad cijene za gotovinsko plaćanje.',
          delivery:
            'solarno.hr radi dostavu i isporuku ISKLJUČIVO na teritoriji Hrvatske. Kupac koji će preuzeti i platiti artikl mora se nalaziti na teritoriji Hrvatske.',
          accuracy:
            'Mi ne garantujemo da su podaci na web-stranici 100% tačni, te ne odgovaramo za posljedice nastale zbog netačnosti navedenih podataka ili slika koje ne predstavljaju stvarni izgled proizvoda.',
          warranty:
            'Garancija na proizvod starta na dan prodaje proizvoda i unosi se u garantni list, te ovjerava pečatom.',
          dataCollection:
            'Za obradu vaše narudžbe potrebni su nam vaši osnovni podaci, kao što su ime i prezime kupca, adresa, e-mail i kontakt broj. Mi ćemo čuvati privatnost podataka kupaca u skladu sa propisima o zaštiti podataka u ovoj branši.',
        },
        ordering: {
          title: 'Naručivanje',
          process:
          ...
          pricing:
            'Cijene navedene na ONLINE SHOP-u izražene su u valuti eura (EUR), međunarodne oznake EUR sa PDV-om.',
          completion:
        ...
        delivery: {
          ...
          inspection:
            'Prilikom preuzimanja kupac je dužan provjeriti stanje pošiljke te u slučaju oštećenja odmah reklamirati proizvod dostavljaču (zaposleniku tvrtke koja vrši dostavu).',
          nonReceipt:
            'Ako kupac ne primi robu, ili obavijest o isporuci, nakon što je poslana, u očekivanom vremenu, kupac ima pravo o tome obavijestiti prodavatelj kako bi se poduzele radnje pronalaska pošiljke.',
          refusal:
          ...
          courierResponsibility:
            'Nakon što dostavljač (firma koja vrši dostavu) zaprimi pošiljku od strane prodavatelja, prodavatelj više nije odgovoran za daljnji tok isporuke i eventualna kašnjenja.',
          downloadOption:
            'Ako kupac umjesto dostave izabere opciju downloada proizvoda, prodavatelj se obvezuje poslati obavijest isključivo u obliku elektronske pošte kupcu na kojoj će se nalaziti linkovi za download i upute.',
        },
        complaints: {
          title: 'Reklamacija',
          guarantee:
            'Prodavatelj se obvezuje isporučiti proizvod koji je tehnički ispravan te odgovara opisu proizvoda navedenom na web aplikaciji.',
          imageDisclaimer:
          ...
          technicalIssues:
            'U slučaju tehničke neispravnosti audio zapisa koji su pohranjeni na prijenosniku zvuka prodavatelj preuzima potpunu odgovornost.',
          procedure:
            'U slučaju tehničke neispravnosti, kupac je dužan reklamirati proizvod u roku od 4 (četiri) radna dana.',
          replacement:
            'Nakon što reklamira tehničku neispravnost kupac je dužan poštom, uz dostavnicu, vratiti tehnički neispravan prijenosnik zvuka nakon čega će prodavatelj u roku od 3(tri) radna dana poslati kupcu zamjenski proizvod, bez ikakve naknade.',
          noRefund:
        ...
        contact: {
          title: 'Trebate pomoć?',
          content:
            'Ako imate bilo kakvih pitanja o sigurnosti plaćanja ili trebate pomoć s narudžbom, naš tim je tu za vas:',
      ...
      contactSupport: {
        ...
        subtitle:
          'Trebate pomoć ili želite više informacija? Mi smo tu za vas. Naši kontakti tu su kako bi Vam pružili svu pomoć i podršku koju trebate, od odabira proizvoda do postprodajne podrške, osiguravajući jednostavno, transparentno i sigurno iskustvo kupovine.',
        contactForm: 'Kontaktni obrazac',
        contactFormText:
          'Ispunite online obrazac na ovoj stranici, unesite svoje podatke i prirodu zahtjeva. Član našeg tima će vas uskoro kontaktirati.',
        name: 'Ime',
        lastName: 'Prezime',
        email: 'Email',
        message: 'Poruka',
        ...
        postSaleAssistanceText:
          'Nakon što ste završili s kupovinom, i dalje smo tu za Vas. Naša usluga postprodajne pomoći na vašoj je dispoziciji za:',
        detailedProductInfo:
          'Pružiti detaljne informacije o proizvodima koje ste odabrali.',
        installationGuidance: 'Voditi vas u ugradnji ili korištenju proizvoda.',
        issueResolution:
          'Pomoći Vam konkretnim, brzim i učinkovitim savjetom i rješenjem.',
        technicalSupport: 'Tehnička podrška i izložbeni salon',
        technicalSupportText:
          'Ako želite direktniji kontakt, ili ako vaš projekt zahtijeva specifičnu tehničku podršku, možete posjetiti jedan od naših centara za pomoć, gdje možete razgovarati s našim stručnjacima i vidjeti proizvode izbliza.',
        returnsShipping: 'Politika povrata i dostave',
        returnsShippingText:
          'Za sve informacije o postupku povrata robe, rokovima i uvjetima istog, obratite se našem Reklamacijskom odjelu. Naša je komunikacija transparentna, kako biste mogli kupovati s potpunim povjerenjem, znajući da smo Vam na raspolaganju u slučaju bilo kakvih promjena ili poteškoća.',
        locationsTitle: 'Naše lokacije',
        locationsSubtitle:
          'Posjetite nas u jednom od naših SolarShop centara diljem Hrvatske.',
        ...
        faqAnswer1:
          'SolarShop nudi širok spektar usluga, uključujući energetske preglede, energetsko modeliranje, ugradnju visokoefikasnih sustava, integraciju obnovljive energije, projektiranje i ugradnju optimalnih solarnih sustava, prilagođenih upravo Vašim potrebama.',
        faqQuestion2: 'Za koga su namijenjene vaše usluge?',
        faqAnswer2:
          'Naše usluge namijenjene su vlasnicima kuća, poduzećima i izvođačima koji žele poboljšati energetsku učinkovitost, smanjiti troškove i implementirati održiva građevinska rješenja.',
        faqQuestion3: 'Kako mi fotonaponski sustavi mogu koristiti?',
        faqAnswer3:
          'Fotonaponski sustavi mogu značajno smanjiti vaše račune za struju, povećati vrijednost vaše nekretnine, pružiti energetsku neovisnost i doprinijeti održivosti okoliša smanjenjem vašeg ugljičnog otiska.',
        faqQuestion4: 'Što je toplinski omotač i zašto je važan?',
        faqAnswer4:
          'Toplinski omotač odnosi se na izolaciju zgrade koja omataju vašu kuću poput jakne, sprječavajući gubitak topline zimi i dobit topline ljeti. To poboljšava energetsku učinkovitost i udobnost uz smanjenje troškova grijanja i hlađenja.',
        faqQuestion5: 'Jesu li vaša energetska rješenja ekološki prihvatljiva?',
        faqAnswer5:
          'Da, sva naša energetska rješenja dizajnirana su s mišlju na održivost. Fokusiramo se na obnovljive izvore energije, energetski učinkovite tehnologije i ekološki odgovorne materijale i prakse.',
        faqQuestion6: 'Možete li upravljati potpunim renovacijama?',
        faqAnswer6:
          'Apsolutno! Pružamo sveobuhvatno upravljanje projektima za potpune renovacije, rješavajući sve od početnog planiranja i dozvola do konačne ugradnje i osiguranja kvalitete.',
        bottomCta:
      ...
      productList: {
        ...
        noProductsFound: 'Nema pronađenih proizvoda',
        adjustFilters:
          'Pokušajte prilagoditi filtere da biste vidjeli više rezultata.',
        itemsPerPage: 'Stavki po stranici',
        showingResults:
          'Prikazuje se {{start}} - {{end}} od {{total}} rezultata',
      },
      // Pagination
      pagination: {
        previous: 'Prethodna',
      ...
      productDetails: {
        ...
        loginRequiredForWishlist:
          'Molimo prijavite se za korištenje liste želja',
        // Bundles & Offers
        ...
        solarStarterBundleDescription:
          'Kompletno rješenje za početnike s panelima, inverterima i osnovnim dodatnom opremom.',
        freeInstallationOffer: 'Besplatna instalacija',
        freeInstallationOfferDescription:
          'Profesionalna instalacija uključena u cijenu. Limitirana ponuda za prvih 50 kupaca.',
      ...
      privacyPolicy: {
        ...
        informationWeCollect: {
          ...
          intro:
            'Prikupljamo informacije koje nam izravno pružate, kao i informacije koje automatski prikupljamo kada koristite naše usluge.',
          personalInfo: {
            title: 'Osobni podaci',
        ...
        sharing: {
          ...
          intro:
            'Ne prodajemo, trgujemo ili iznajmljujemo vaše osobne podatke. Možemo podijeliti vaše informacije samo u sljedećim okolnostima:',
          serviceProviders:
            'S pouzdanim pružateljima usluga koji nam pomažu u poslovanju',
        ...
        security: {
          ...
          description:
            'Provodimo odgovarajuće sigurnosne mjere za zaštitu vaših osobnih podataka od neovlaštenog pristupa, mijenjanja, otkrivanja ili uništavanja.',
        },
        rights: {
          title: 'Vaša prava',
        ...
        contact: {
          ...
          description:
            'Ako imate pitanja o ovim Pravilima privatnosti, molimo kontaktirajte nas:',
          email: {
            label: 'Email',
        ...
        changes: {
          ...
          description:
            'Možemo povremeno ažurirati ova Pravila privatnosti. Obavijestit ćemo vas o značajnim promjenama objavljivanjem nove politike na ovoj stranici.',
        },
      },
      // Terms of Service
      termsOfService: {
        ...
        acceptance: {
          ...
          description:
            'Pristupom i korištenjem ove web stranice prihvaćate i pristajete biti vezani uvjetima i odredbama ovog sporazuma.',
        },
        services: {
          title: 'Opis usluga',
          description:
            'SolarShop pruža proizvode solarne energije i povezane usluge uključujući:',
        ...
        accounts: {
          ...
          description:
            'Kada stvarate račun kod nas, morate pružiti točne i potpune informacije. Odgovorni ste za:',
        ...
        orders: {
          ...
          description:
            'Sve narudžbe podliježu prihvaćanju i dostupnosti. Zadržavamo pravo odbiti ili otkazati bilo koju narudžbu.',
          pricing: {
            title: 'Cijene',
            description:
              'Sve cijene su navedene u EUR i uključuju primjenjive poreze osim ako nije drugačije navedeno.',
          },
          payment: {
            title: 'Plaćanje',
            description:
              'Plaćanje mora biti primljeno prije slanja proizvoda. Prihvaćamo glavne kreditne kartice i bankovne transfere.',
          },
        },
        shipping: {
          ...
          delivery:
            'Vremena dostave variraju ovisno o lokaciji i dostupnosti proizvoda',
        ...
        returns: {
          ...
          description:
            'Želimo da budete zadovoljni vašom kupovinom. Naša politika povrata uključuje:',
          timeLimit: '30-dnevni rok za povrat većine proizvoda',
          condition: 'Predmeti moraju biti u originalnom stanju i pakiranju',
          authorization:
            'Potrebna je autorizacija povrata prije slanja predmeta natrag',
          refund: 'Refundacije se obrađuju u roku od 5-10 radnih dana',
        },
        warranties: {
          title: 'Jamstva',
          description:
            'Proizvodi dolaze s jamstvima proizvođača. Pružamo dodatnu jamstvenu podršku kao ovlašteni diljer.',
        },
        liability: {
          title: 'Ograničavanje odgovornosti',
          description:
            'Naša odgovornost je ograničena u najvećoj mjeri dozvoljenoj zakonom. Nismo odgovorni za neizravne, slučajne ili posljedične štete.',
        },
        intellectual: {
          title: 'Intelektualno vlasništvo',
          description:
            'Sav sadržaj na ovoj web stranici je zaštićen autorskim pravom i drugim pravima intelektualnog vlasništva. Ne smijete reproducirati ili distribuirati sadržaj bez dozvole.',
        },
        law: {
          title: 'Mjerodavno pravo',
          description:
            'Ovi uvjeti su uređeni hrvatskim pravom. Svi sporovi će se rješavati pred hrvatskim sudovima.',
        },
        contact: {
          title: 'Kontaktne informacije',
          description:
            'Za pitanja o ovim Uvjetima korištenja, kontaktirajte nas:',
          email: {
            label: 'Email',
        ...
        changes: {
          ...
          description:
            'Zadržavamo pravo mijenjanja ovih uvjeta u bilo koje vrijeme. Promjene će stupiti na snagu odmah nakon objavljivanja.',
        },
      },
      // Cookie Policy
      cookiePolicy: {
        ...
        whatAreCookies: {
          ...
          description:
            'Kolačići su male tekstualne datoteke koje se postavljaju na vaše računalo ili mobilni uređaj kada posjećujete našu web stranicu. Pomažu nam pružiti vam bolje iskustvo.',
        },
        typesOfCookies: {
          ...
          essential: {
            ...
            description:
              'Ovi kolačići su potrebni da web stranica ispravno funkcionira. Omogućavaju osnovne funkcije poput navigacije stranicama i pristupa sigurnim područjima.',
          ...
          performance: {
            ...
            description:
              'Ovi kolačići prikupljaju informacije o tome kako posjetitelji koriste našu web stranicu, pomažući nam poboljšati performanse.',
          ...
          functional: {
            ...
            description:
              'Ovi kolačići poboljšavaju funkcionalnost naše web stranice pamteći vaše izbore i preferencije.',
          ...
          marketing: {
            ...
            description:
              'Ovi kolačići se koriste za isporuku relevantnih oglasa i praćenje učinkovitosti marketinških kampanja.',
        ...
        thirdParty: {
          ...
          description:
            'Možemo koristiti usluge treće strane koje postavljaju kolačiće na vaš uređaj:',
        ...
        management: {
          ...
          browserSettings: {
            ...
            description:
              'Možete kontrolirati kolačiće kroz postavke vašeg preglednika. Većina preglednika vam omogućava blokiranje ili brisanje kolačića.',
          },
          consent: {
            title: 'Pristanak za kolačiće',
            description:
              'Tražit ćemo vaš pristanak prije postavljanja nebitnih kolačića na vaš uređaj.',
          },
          optOut: {
            title: 'Linkovi za odjavu',
            description:
              'Možete se odjaviti od određenih kolačića putem sljedećih linkova: Google Analytics, Facebook, itd.',
          },
        },
        duration: {
          ...
          session: {
            ...
            description:
              'Ovi kolačići se brišu kada zatvorite vaš pregljednik.',
          },
          persistent: {
            title: 'Trajni kolačići',
            description:
              'Ovi kolačići ostaju na vašem uređaju određeno vrijeme ili dok ih ne obrišete.',
          },
        },
        updates: {
          title: 'Ažuriranja ovih pravila',
          description:
            'Možemo povremeno ažurirati ova Pravila o kolačićima. Molimo pregledajte ovu stranicu povremeno za promjene.',
        },
        contact: {
          title: 'Kontaktirajte nas',
          description:
            'Ako imate pitanja o našoj uporabi kolačića, molimo kontaktirajte nas:',
          email: {
            label: 'Email',
            value: 'privatnost@solarshop.hr',
          },
    ...
    en: {
      ...
      register: {
        ...
        confirmEmailToUnlock:
          'Confirm your email to unlock all the features of SolarShop',
        confirmationEmailSentSuccess:
      ...
      forgotPassword: {
        ...
        subtitle:
          "No problem, we'll send you instructions to reset your password.",
      ...
      partnersRegister: {
        ...
        applicationMessage:
          "Your application for partnership has been sent for review. We'll be in touch soon.",
      ...
      b2b: {
        ...
        about: {
          ...
          heroSubtitle:
            'Discover exclusive benefits, special pricing and business support in the solar industry',
          benefits: 'Benefits of Partnership',
          exclusivePricing: 'Exclusive Pricing',
          exclusivePricingText:
            'Access special prices and discounts for partners.',
          pricingTitle: 'Special Partner Pricing',
          pricingSubtitle:
            'Achieve significant savings with our partner pricing',
          pricingDescription:
            'As our partner, you gain access to exclusive pricing lower than standard prices. Your savings increase with order volume.',
          pricingBenefits: {
          ...
          dedicatedSupportText:
            'Personal account manager and technical support.',
          supportTitle: 'Superior Partner Support',
          supportSubtitle: 'Get priority support and personal attention',
          supportDescription:
            'Our expert team is available for all your needs. From technical questions to order assistance, we are here for you.',
          supportBenefits: {
            personalManager: 'Personal Account Manager',
            personalManagerText: 'Dedicated contact for all your needs',
            technicalSupport: 'Technical Support',
            technicalSupportText: 'Technical support from experts',
          ...
          marketingSupportText:
            'Marketing materials and support for promotion.',
          marketingTitle: 'Marketing & Education',
          marketingSubtitle: 'Grow your business with our support',
          marketingDescription:
            'We provide you with all the necessary materials and training to successfully present our products to your customers.',
          marketingBenefits: {
            marketingMaterials: 'Marketing Materials',
            marketingMaterialsText:
          ...
          requirementsText:
            'Learn what we need from you to become our partner.',
          requirementsTitle: 'Partnership Requirements',
          requirementsSubtitle: 'Simple process to become a partner',
          requirementsDescription:
            'Our partnership process is designed to be simple and transparent. Here is what you need:',
          ...
          commitmentText:
            'Commitment to providing high-quality services to our customers.',
        ...
        contact: {
          ...
          partnerSupportText:
            'Partner support is available to assist you with any questions or issues you may have.',
          ...
          salesTeamText:
            'Our sales team is available to assist you with any questions or issues you may have.',
          salesTeamEmail: 'prodaja@solarni-paneli.hr',
          salesTeamPhone: '+385 1 234 5679',
          technicalSupport: 'Technical Support',
          technicalSupportText:
            'Our technical support team is available to assist you with any questions or issues you may have.',
          technicalSupportEmail: 'webshop@solarno.hr',
          technicalSupportPhone: '+385 (1) 6407 715',
          supportEmail: 'prodaja1@solarni-paneli.hr',
        ...
        products: {
          ...
          companyNotApproved:
            'Your company is not yet approved for partnership',
          companyNotApprovedMessage:
            'Please apply for partnership or contact our support team',
          applyForPartnership: 'Apply for Partnership',
          yourPrice: 'Your Price',
          partnerOnly: 'Partner Only',
          pendingPrice: 'Pending Price',
          pendingPriceMessage:
            'Contact us for specific pricing for your company',
          // Filter and UI translations
          filters: 'Filters',
        ...
        auth: {
          ...
          partnerVerificationRequired:
            'Partner verification required to view exclusive offers',
          becomePartner: 'Become a Partner',
          partnerVerificationRequiredPricing:
            'Partner verification required to view pricing',
        ...
        offers: {
          ...
          noPartnerPricingAvailable:
            'Partner pricing not available for this product',
          quantityTierPricing: 'Quantity tier pricing',
          productDiscount: 'Product discount',
          percentageDiscountDescription:
            'Percentage discount applied to this product',
          yourPrice: 'Your Price',
          ...
          contactSupportForPricingDescription:
            'Contact our support team for pricing information and special partnership terms.',
          offerNotAvailable: 'Offer not available',
          noPartnerPricingForAnyProduct:
            'Partner pricing is not available for any product in this offer',
          productsWithPricing: 'Products with partner pricing',
          categoryDiscount: 'Category Discount',
          categoryDiscountDescription:
            'This discount applies to the entire product category',
          discount: 'discount',
          ...
          addedProductsToCart:
            'Added {{count}} product{{count > 1 ? "s" : ""}} to your B2B cart successfully!',
          productsOutOfStock:
            '{{count}} product{{count > 1 ? "s were" : " was"}} out of stock.',
          productsFailedToAdd:
            '{{count}} product{{count > 1 ? "s" : ""}} failed to add.',
          allProductsOutOfStock: 'All products are currently out of stock.',
          offerClaimed: 'Offer "{{title}}" claimed successfully!',
          offerClaimedWithProducts:
            'Offer "{{title}}" claimed - {{count}} products added to cart!',
          useCouponCode: 'Use coupon code: {{code}}',
          couponAppliedAutomatically:
            'Coupon code {{code}} applied automatically.',
          itemsOutOfStock: '{{count}} items out of stock.',
          offerClaimedButOutOfStock:
            'Offer "{{title}}" claimed, but all products are out of stock.',
          ...
          generalOfferDescription:
            'This offer applies to the entire product catalog',
          ...
          bundleRequiresAllProductsInCart:
            'All products must be in cart to apply discount',
        },
        profile: {
          ...
          accessDeniedMessage:
            'You do not have permission to access this page. You need to be an approved partner.',
          ...
          pendingApprovalDescription:
            'Your partnership application is under review',
          approvedPartnerDescription:
      ...
      b2bCart: {
        ...
        qty: 'Qty',
        addMoreForTier:
          'Add {{qty}} more for €{{price}} each (save €{{savings}})',
      },
      // B2B Shipping translations
      b2bShipping: {
      ...
      admin: {
        ...
        productDimensionsHelp:
          'Enter dimensions in format: length x width x height unit (e.g. 100x50x20cm, 10x5x2m, 1000x500x200mm)',
        ...
        productSpecificationsHelp:
          'Enter one specification per line (e.g. Frequency: 50Hz, Voltage: 230V)',
        productFeatures: 'Features',
        productFeaturesHelp:
          'Enter one feature per line (e.g. Dual MPPT trackers, WiFi monitoring)',
        productCertifications: 'Certifications',
        productCertificationsHelp:
          'Enter one certification per line (e.g. IEC 61215, IEC 61730)',
        productTechnicalSheet: 'Technical Sheet',
        productTechnicalSheetHelp:
          'URL to the product technical documentation (e.g. PDF with technical specifications)',
        ...
        productRelationshipsNoRelationshipsDescription:
          'Add related products or categories to enhance product visibility.',
        ...
        productImportError:
          'Error importing products. Please check the CSV format.',
        ...
        categoriesForm: {
          ...
          errorImportingCategories:
            'Error importing categories. Please check the CSV format.',
          ...
          categoryHasRelatedProducts:
            'Category cannot be deleted because it contains related products. Please remove all products from this category first.',
        ...
        companiesForm: {
          ...
          noCompaniesFoundDescription:
            'There are currently no companies that match your search criteria.',
          basicInformation: 'Basic information',
          contactInformation: 'Contact information',
          address: 'Address',
          ...
          confirmApprovalMessage:
            'Are you sure you want to approve the company',
          approveCompany: 'Approve Company',
          approvalNote:
            'Approval will grant the company access to B2B features and custom pricing.',
          ...
          noDataFoundInCsvFile: 'No data found in CSV file',
          errorImportingCompanies:
            'Error importing companies. Please check the CSV format.',
        },
        companyPricingForm: {
          ...
          priceDescription:
            'Enter custom price in euros for this product and company',
          ...
          errorDeletingPricing:
            'Error deleting company pricing. Please try again.',
          ...
          bulkDiscountHint:
            'Bulk discount allows you to set discounts on multiple products at once.',
          discount: 'discount',
          // Alert messages
          confirmBulkDiscountAll:
            'Apply {{percentage}}% discount to ALL companies and ALL products? This will update all existing pricing records.',
          bulkDiscountAppliedAll:
            'Bulk discount of {{percentage}}% applied to all {{count}} products',
          bulkDiscountAppliedFiltered:
            'Bulk discount of {{percentage}}% applied to {{count}} filtered products',
          ...
          errorImportingCsv:
            'Error importing CSV file. Please check the console for details and try again.',
          ...
          errorExportingCompanyPricing:
            'Error exporting company pricing data. Please try again.',
          successfullyDeletedAllCustomPricing:
            'Successfully deleted all custom pricing for {{companyName}}',
          errorDeletingCompanyPricing:
            'Error deleting company pricing. Please try again.',
          // Bulk discount loading messages
          bulkDiscountProcessing: 'Processing bulk discount...',
          bulkDiscountProgress:
            'Processed {{current}} of {{total}} company-product combinations',
          bulkDiscountCompleted:
            'Bulk discount successfully applied to {{count}} combinations',
          confirmBulkDiscountCompany:
            'Apply {{percentage}}% discount to all products for this company?',
          confirmBulkDiscountFiltered:
            'Apply {{percentage}}% discount to {{count}} filtered products?',
          confirmClearAllPricing:
            'Are you sure you want to clear all custom pricing for this company?',
        },
        companyPricingDetails: {
        ...
        contactsForm: {
          title: 'Complaints',
          subtitle: 'Manage complaint messages from customers',
        ...
        offersForm: {
          ...
          categoryTooltip:
            'Selecting a category will filter the product list for that category only',
          applyToCategory: 'Apply to entire category',
          applyToCategoryTooltip:
            'Check to apply discount to all products in the selected category',
          individualProducts: 'Individual products',
          individualProductsTooltip:
            'Add products individually with different discounts',
          categoryDiscount: 'Category discount',
          categoryDiscountTooltip:
            'Discount that will be applied to all products in the category',
          ...
          categoryChangePrompt:
            'You have {{count}} product(s) that are not in the selected category "{{categoryName}}". Would you like to remove them and keep only products from this category?',
          categoryChangePromptTitle: 'Category Change',
          categoryChangePromptMessage:
            'Selecting a new category will filter available products. Would you like to remove existing products that are not in this category?',
          allCategoryProductsAdded:
            'All products from this category have already been added to the offer.',
          productNotInSelectedCategory:
            'This product does not belong to the selected category.',
          productAlreadyAdded:
            'This product has already been added to the offer.',
          ...
          totalProductDiscountsExceed:
            'Product discounts will match the global discount of €{{amount}}',
          locked: 'Locked',
          matchesGlobalDiscount: 'Matches global discount',
          autoSetToMatchGlobalDiscount: 'Auto-set to match global discount',
          productDiscountMustMatch:
            'Product discount must be exactly {{type}}{{value}} to match the global offer discount',
          bundleConfiguration: 'Bundle Configuration',
          bundleOffer: 'Bundle Offer',
          bundleOfferDescription:
            'Bundle offer requires purchasing all products together',
          bundleOfferNotice: 'Bundle Offer Notice',
          bundleRequiresAllProducts:
            'Bundle offer requires purchasing all products',
          bundleDiscountAppliedOnlyWhenComplete:
        ...
        partnerOrdersForm: {
          ...
          confirmOrderDeletion: 'Confirm Order Deletion',
          confirmOrderDeletionMessage:
            'Are you sure you want to delete this partner order? This action cannot be undone.',
        ...
        common: {
          ...
          orderStatusChangeMessage:
            'Order status marked to change from "{{oldStatus}}" to "{{newStatus}}". Click "Save Changes" to apply.',
          paymentStatusChangeMessage:
            'Payment status marked for update. Click "Save Changes" to apply.',
          invoicePrintingInitiated:
            'Invoice printing for order {{orderNumber}} initiated successfully!',
          showing: 'Showing',
          to: 'to',
          of: 'of',
          results: 'results',
      ...
      sortOptions: {
        ...
        noSortOptionsDescription:
          'Add sort options so users can sort products.',
        ...
        sortFieldsHint:
          'Add one or more fields to sort by. Order matters - sorts by first field first, then by second, etc.',
        addField: 'Add Field',
        fields: {
          name: 'Name',
          price: 'Price',
      ...
      reviewsSection: {
        ...
        mustPurchaseFirst:
          'You can only write reviews for products you have purchased and received.',
      ...
      adminWishlist: {
        ...
        noWishlistItemsDescription:
          'This user has no items in their wishlist yet.',
        added: 'Added',
      ...
      hero: {
        ...
        subtitle:
          'Fronius, Huawei, GoodWe - premium solar equipment brands. Fast delivery in Croatia.',
      ...
      offers: {
        ...
        noOffersText:
          'There are currently no active offers. Check our product range.',
        ...
        defaultDescription:
          'This is a special offer for selected products. Take advantage of the discount and save on your purchase.',
        highlights: 'Highlights',
        addedSuccessfully:
          'Added {{count}} product{{count > 1 ? "s" : ""}} to cart successfully!',
        noProductsToAdd: 'No products available to add to cart.',
        addedProductsToCart:
          'Added {{count}} product{{count > 1 ? "s" : ""}} to cart successfully!',
        productsOutOfStock:
      ...
      mission: {
        ...
        subtitle:
          "At SolarShop, we believe that building and renovating doesn't just mean creating comfortable and functional spaces, but also taking care of the environment we live in.",
        ...
        certificationText:
          'Before proposing a product, we verify its environmental and quality certifications, such as LEED, CasaClima, FSC, PEFC or ISO 14001.',
        energyEfficiency: 'Energy Efficiency',
        efficiencyText:
          'We choose products and solutions that improve thermal insulation, reduce consumption and favor the use of renewable energy sources.',
      ...
      sustainability: {
        ...
        greenCertificationsText:
          'Heating and cooling using heat pumps, furnaces, and air-conditioning systems today represent the most common and most efficient solutions for maintaining a comfortable temperature in homes and commercial spaces. Each of these systems has its own advantages, and the choice depends on user needs, the type of building, and energy goals.',
      ...
      blog: {
        ...
        recentProjectsSubtitle:
          'Discover the latest solar projects, technical insights and expert advice from our team',
        ...
        technicalGuidesText:
          'Detailed guides for installation, maintenance and optimization of solar systems.',
        regulationsInsights: 'Regulations Insights',
        regulationsText:
          'Latest information on solar incentives, laws and regulations.',
        sustainabilityTips: 'Sustainability Tips',
        sustainabilityText:
          'Practical tips for green living and maximizing energy efficiency.',
        caseStudies: 'Case Studies',
        caseStudiesText:
          'Real examples of successful solar installations and their results.',
        faqTutorials: 'FAQ and Tutorials',
        faqText:
          'Answers to frequently asked questions and step-by-step tutorials.',
        trustedPartner: 'Your trusted partner',
        partnerText:
          'Over 10 years of experience in the solar industry. Our team of experts shares knowledge through informative articles that help you make the right decisions.',
        // Date and time formatting
      ...
      company: {
        title: 'Our Company',
        subtitle:
          'Welcome to the section dedicated to our company. Here you can learn more about us, our history, our values and the team.',
        whoWeAre: 'Who We Are',
        whoWeAreText:
          'SolarShop was born from the experience of professionals in the construction sector who, by combining their skills, decided to create a portal.',
        mission:
          'Our mission is simple: to make accessible to everyone the most innovative solutions for sustainable construction.',
        ourTeam: 'Our Goal',
        teamText1:
        ...
        innovationText:
          'We focus on the most advanced technologies and on last generation materials.',
        sustainability: 'Sustainability',
        sustainabilityText:
          'We respect the planet, choosing low-impact materials, encouraging the use of renewable energies.',
        support: 'Support',
        supportText:
          'We accompany you in every phase, from product selection to post-sale assistance.',
        suppliersPartners: 'Suppliers and Partners',
        partnersText:
          'We collaborate with the most established brands and specialized companies.',
        socialResponsibility: 'Social Responsibility and Environmental',
        responsibilityText:
          'Our commitment does not stop at the product. We commit to promoting the culture of sustainability.',
      },
      // Cart
      cart: {
        title: 'Your cart',
        ...
        couponAlreadyUsedInSession:
          'This coupon has already been used in this session',
        couponCannotApplyToDiscountedProducts:
          'This coupon cannot be applied to already discounted products',
        couponMinOrderNotMet:
          'Minimum order amount of €{{amount}} required for this coupon',
        couponMaxOrderExceeded:
          'Maximum order amount of €{{amount}} exceeded for this coupon',
        couponNotApplicableToOffers:
          'This coupon is not applicable to the offers in your cart',
        couponExcludedFromOffers:
          'This coupon cannot be used with the offers in your cart',
        couponNotApplicableToProducts:
          'This coupon is not applicable to the products in your cart',
        couponExcludedFromProducts:
          'This coupon cannot be used with some products in your cart',
        couponNotApplicableToCategories:
          'This coupon is not applicable to the product categories in your cart',
        couponExcludedFromCategories:
          'This coupon cannot be used with some product categories in your cart',
      ...
      checkout: {
        ...
        pickupAtStorageDescription:
          'Pick up your order directly from our warehouse. Free and available on working days.',
        paymentMethod: 'Payment Method',
        payOnDeliveryDescription:
        ...
        guestCheckoutDescription:
          "You can complete your order without creating an account. Your order will be processed and you'll receive confirmation via email.",
        ...
        orderCreated:
          'Order #{{number}} has been created and is pending review.',
        backStep: 'Back to',
        nextStep: 'Continue to',
        businessOrder: 'Business Order',
        businessOrderDescription:
          'Check this option for business purchases with special pricing, invoicing and priority support options.',
        ...
        securePaymentDescription:
          'Your card details will be securely entered on the Monri payment platform.',
        orderingDisabled: 'Ordering Currently Unavailable',
        orderingDisabledDescription:
          'Ordering is currently disabled. Please try again later or contact us for more information.',
      },
      // Payment
      payment: {
        ...
        cancelledDescription:
          'Payment has been cancelled. You can try again or return to your cart.',
        orderNumber: 'Order Number',
      ...
      orderConfirmation: {
        ...
        description:
          'Thank you for your purchase! Your order has been successfully created and will be processed shortly.',
        orderNumber: 'Order Number',
      ...
      footer: {
        companyDescription:
          'We are Solar Shop, a company specialized in modern and reliable solar solutions. We provide the sale and installation of high-quality solar systems, as well as professional consulting. Our goal is to enable clients to make a simple transition to clean energy and achieve long-term savings.',
        address: 'Bani ul. 73, 10010, Buzin, Croatia',
        phone: '+385 (1) 6407 715',
        email: 'webshop@solarno.hr',
      ...
      safetyPayment: {
        ...
        creditCardSecurity: {
          title: 'Credit card payment security',
          intro:
            'The confidentiality of your data is protected and secured using SSL encryption.',
          sslDescription:
            'Internet payment pages are secured using Secure Socket Layer (SSL) protocol with 128-bit data encryption. SSL encryption is a data encryption process to prevent unauthorized access during their transmission.',
          dataTransfer:
            "This enables secure information transfer and prevents unauthorized access to data during communication between the user's computer and WebPay service, and vice versa.",
          vpnSecurity:
          ...
          merchantSecurity:
            'The merchant does not store credit card numbers and the numbers are not available to unauthorized persons.',
        },
        privacyStatement: {
          ...
          dataAccess:
            'All user data is strictly protected and accessible only to employees who need this data to perform their work.',
          employeeResponsibility:
            'All our employees and business partners are responsible for respecting privacy protection principles.',
        },
        termsOfUse: {
          title: 'Terms of use',
          ownership:
            'ONLINE WEB SHOP (solarno.hr) is owned by Hvaljen budi d.o.o.. Through the ONLINE WEB SHOP we offer information services and online ordering and purchasing of products.',
          availability:
            'ONLINE WEB SHOP is active 24 hours a day, every day of the year. Access to the online store may be temporarily disabled for maintenance or possible technical problems.',
          compliance:
            'solarno.hr as a service provider adheres to legal regulations with the aim of protecting user privacy, and the terms of use are made in accordance with international online business customs.',
          pricing:
            'Prices listed on the ONLINE SHOP are expressed in the currency euro (EUR), international designation EUR. Prices are retail, including VAT, and the valid price is the price stated at the time of receiving the order.',
          payment:
            'For card payments in installments or other payment methods, the full prices in this case (crossed out prices) are above the cash payment price.',
          delivery:
            'solarno.hr delivers and ships EXCLUSIVELY on the territory of Croatia. The customer who will pick up and pay for the item must be located on the territory of Croatia.',
          accuracy:
            'We do not guarantee that the data on the website is 100% accurate, and we are not responsible for consequences arising from inaccurate data or images that do not represent the actual appearance of the product.',
          warranty:
            'Product warranty starts on the day of product sale and is entered in the warranty card and certified with a stamp.',
          dataCollection:
            "To process your order, we need your basic information, such as the customer's first and last name, address, e-mail and contact number. We will keep customer data privacy in accordance with data protection regulations in this industry.",
        },
        ordering: {
          title: 'Ordering',
          process:
            'The customer orders a product or products through an electronic order form. A customer is considered any person who electronically orders at least one product, fills in the required data and sends the order.',
          pricing:
            'Prices listed on the ONLINE SHOP are expressed in the currency euro (EUR), international designation EUR with VAT.',
          completion:
            'Goods are ordered electronically, by clicking on a specific product and storing it in the cart. The goods are considered ordered when the customer selects and confirms the payment method.',
        },
        paymentSection: {
          title: 'Payment',
          methods:
        ...
        delivery: {
          ...
          inspection:
            'Upon receipt, the customer is obliged to check the condition of the shipment and in case of damage, immediately file a complaint with the deliverer (employee of the company that performs the delivery).',
          nonReceipt:
            'If the customer does not receive the goods, or notification of delivery, after it has been sent, within the expected time, the customer has the right to inform the seller so that actions can be taken to find the shipment.',
          refusal:
            'If the customer refuses to receive the goods they ordered, the seller has the right to demand compensation from the customer for all costs related to delivery.',
          timeline:
            'The seller undertakes to send the shipment to the customer the moment they receive confirmation approving the online transaction. After receiving this confirmation, the seller undertakes to send the shipment within 5 (five) working days.',
          courierResponsibility:
            'After the deliverer (company that performs delivery) receives the shipment from the seller, the seller is no longer responsible for the further course of delivery and possible delays.',
          downloadOption:
            'If the customer chooses the product download option instead of delivery, the seller undertakes to send a notification exclusively in the form of e-mail to the customer which will contain download links and instructions.',
        },
        complaints: {
          title: 'Complaints',
          guarantee:
            'The seller undertakes to deliver a product that is technically correct and corresponds to the product description listed on this web application.',
          imageDisclaimer:
            'The image that illustrates the product on the Internet page does not have to correspond to the actual appearance of the product and the customer cannot complain about this segment.',
          technicalIssues:
            'In case of technical malfunction of audio recordings stored on the sound carrier, the seller assumes full responsibility.',
          procedure:
            'In case of technical malfunction, the customer is obliged to complain about the product within 4 (four) working days.',
          replacement:
            'After complaining about the technical malfunction, the customer is obliged to return the technically defective sound carrier by mail, with a delivery note, after which the seller will send the customer a replacement product within 3 (three) working days, without any charge.',
          noRefund:
            'In the above case, the customer does not have the right to demand a refund, but exclusively a replacement product.',
          courierLimitation:
        ...
        contact: {
          title: 'Need help?',
          content:
            'If you have any questions about payment security or need help with your order, our team is here for you:',
          email: 'Send email',
          phone: 'Call us',
        },
      },
      ...
      contactSupport: {
        ...
        faqAnswer1:
          'SolarShop offers a wide range of services, including energy audits, energy modeling, high-efficiency system installations, renewable energy integration, building envelope upgrades, mechanical system upgrades, electrical system upgrades, plumbing system upgrades, and comprehensive project management.',
        faqQuestion2: 'Who are your services designed for?',
        faqAnswer2:
          'Our services are designed for homeowners, businesses, and contractors looking to improve energy efficiency, reduce costs, and implement sustainable building solutions.',
        faqQuestion3: 'How can photovoltaic systems benefit me?',
        faqAnswer3:
          'Photovoltaic systems can significantly reduce your electricity bills, increase your property value, provide energy independence, and contribute to environmental sustainability by reducing your carbon footprint.',
        faqQuestion4: 'What is a thermal jacket, and why is it important?',
        faqAnswer4:
          'A thermal jacket refers to building insulation that wraps around your home like a jacket, preventing heat loss in winter and heat gain in summer. This improves energy efficiency and comfort while reducing heating and cooling costs.',
        faqQuestion5: 'Are your energy solutions environmentally friendly?',
        faqAnswer5:
          'Yes, all our energy solutions are designed with sustainability in mind. We focus on renewable energy sources, energy-efficient technologies, and environmentally responsible materials and practices.',
      ...
      productDetails: {
        ...
        solarStarterBundleDescription:
          'Complete solution for beginners with panels, inverters, and essential accessories.',
        freeInstallationOffer: 'Free Installation',
        freeInstallationOfferDescription:
          'Professional installation included in price. Limited offer for first 50 customers.',
      ...
      privacyPolicy: {
        ...
        informationWeCollect: {
          ...
          intro:
            'We collect information you provide directly to us, as well as information we gather automatically when you use our services.',
          personalInfo: {
      ...
      termsOfService: {
        ...
        services: {
          ...
          description:
            'SolarShop provides solar energy products and related services including:',
        ...
        orders: {
          ...
          pricing: {
            title: 'Pricing',
            description:
              'All prices are listed in EUR and include applicable taxes unless otherwise stated.',
          },
          payment: {
            title: 'Payment',
            description:
              'Payment must be received before products are shipped. We accept major credit cards and bank transfers.',
          },
        },
        shipping: {
          ...
          damages:
            'Inspect packages upon delivery and report damages immediately',
        },
        returns: {
        ...
        warranties: {
          title: 'Warranties',
          description:
            'Products come with manufacturer warranties. We provide additional warranty support as an authorized dealer.',
        },
        liability: {
        ...
        intellectual: {
          ...
          description:
            'All content on this website is protected by copyright and other intellectual property rights. You may not reproduce or distribute content without permission.',
        },
        law: {
          title: 'Governing Law',
          description:
            'These terms are governed by Croatian law. Any disputes will be resolved in Croatian courts.',
        },
        contact: {
      ...
      cookiePolicy: {
        ...
        typesOfCookies: {
          ...
          functional: {
            ...
            description:
              'These cookies enhance the functionality of our website by remembering your choices and preferences.',
        ...
        management: {
          ...
          optOut: {
            title: 'Opt-Out Links',
            description:
              'You can opt out of certain cookies through the following links: Google Analytics, Facebook, etc.',
          },
        },
        duration: {
      ...
      b2bCheckout: {
        ...
        businessOrder: 'Business Order',
        businessOrderDescription:
          'This order will be processed as a B2B transaction',
        bulkDiscounts: 'Bulk Discounts',
        prioritySupport: 'Priority Support',
        customInvoicing: 'Custom Invoicing',
        termsAndConditions: 'I accept the',
        ...
        paymentUponCollection: 'Payment upon collection',
        paymentUponCollectionDescription:
          'Pay when you collect goods at our store',
        specialInstructions: 'Special Instructions',
        specialInstructionsPlaceholder:
          'Any special requirements or notes for your order...',
  ...
  translate(key: string, params?: Record<string, string | number>): string {
    ...
    if (typeof translation !== 'string') {
      console.warn(
        `Translation not found for key: ${key} in language: ${currentLang}`,
      );
      return key;
    }
